                    ...
                    <div className='market-main'>
                        <div className='market-left'>
                            <div className='input-wrap'>
                                ...
                                <div className='input-icon'>
                                    <img width='14' height='16' src={require('../../assets/img/market/search@2x.png')} alt=""/>
                                </div>
                            </div>
                                ...
                                <div className='market-left-element'>
                                    {
                                        element.map((item, index) =>
                                            <div className='market-left-element-item' key={`market-left-element-item-${index}`}>
                        ...
                        <div className="market-right">
                            ...
                            <div className='market-right-main'>
                                {
                                    role.map((item, index) =>
                                        <div className='market-right-main-item' key={`market-right-main-item-${index}`}>
                                            ...
                                            <div className='market-right-main-item-price-wrap'>
                                                <img width='21' src={require('../../assets/img/market/hash@2x.png')} alt=""/>
