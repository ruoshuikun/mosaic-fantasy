                ...
                <div className='learn-more'>
                    ...
                    <div id='learn-more-content'>
                        <div className='learn-more-content' id='0-0'>
                            ...
                            <div className='learn-more-content-desc'>
                                <div className='mb-default'>
                                    MF (MosaicFantasy) is a massive blockchain game based on BSC (Binance Smart Chain)
                                    which
                                    allows the gamers to “Play to Earn”. With self-operating ecological economy, MF
                                    creates
                                    an
                                    independent and sophisticated virtual world in which lives various fantastic
                                    creatures
                                    holding superpower-Mosaic. In this amazing world, players are able to obtain,
                                    upgrade
                                    and
                                    synthetize different kinds of Mosaic by taking part in the adventure, battles and
                                    other
                                    ecological contribution. Besides, players can earn relevant cryptocurrency and MF
                                    tokens
                                    as
                                    well.
                                </div>
                                <div>
                                    ...
                                    reality
                                    and virtuality and becomes the second space for human working, entertainment and
                                    social
                                    life
                                    in the future!
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className='learn-more-content-desc'>
                                        <div>
                                            ...
                                            decentralized blockchain network. That makes them open to anyone to use,
                                            rather
                                            than traditional centralized finance like banks or brokerages. With a system
                                            by
                                ...
                                <div>
                                    ...
                                    <div className='learn-more-content-desc'>
                                        <div>
                                            ...
                                            Unlike
                                            Fungible Tokens such as BTC and ETH which are identical to each other, NFT
                                            is
                                            unique in its identification and indivisible with minimum unit 1. Therefore,
                                            non-fungible, unique and inalterable characteristics of NFT make it become
                                            the
                                            perfect medium for commercial transactions, especially in digital art and
                                            games.
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className='learn-more-content-desc'>
                                        <div>
                                            ...
                                            presenting decentralized financial products through games. It triggers the
                                            new
                                            model of “Play to Earn” other than “Play to Win”. In other words, players
                                            can
                                            not only win equipment or tools in the game, but in turn, those equipment or
                                            tools are also digital assets measured by NFT which can be traded for fiat
                                            money
                                            and spend in real life. GameFi makes the game both enjoyable and profitable
                                            for
                                            players.
                                        </div>
                                    </div>
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                <div>
                                    MosaicFantasy is a project based on BSC chain, so players need to create a BSC
                                    address.
                            ...
                            <div>
                                <div>
                                    ...
                                    <div className='learn-more-content-desc'>
                                        ...
                                        <div>Click on the "+" sign in the upper right corner to display the token assets
                                            you
                                ...
                                <div>
                                    ...
                                    <div className='learn-more-content-desc'>
                                        <p>
                                            MetaMask is a plug-in type Ethereum wallet that is used on Google Chrome.
                                            You
                                        ...
                                        <img className='learn-more-content-desc-step-img' width='846' height='406'
                                             ...
                                             alt=""/>
                                        <div>Later, you can see that there is an extra option for Binance Smartchain.
                                            You
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    ...
                                    characteristics and attributes which decide its role in the battle. Players can not
                                    only
                                ...
                                <p>
                                    ...
                                    different combat effectiveness. Accordingly, the Mosaic NFT with different levels on
                                    the
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                ...
                                <p>
                                    Step4: Find more details about the MosaicNFT sold on the market. Click the button
                                    “Buy
                                    now” to purchase the Mosaic on the condition that you have enough tokens in your
                                    wallet.
                                </p>
                                <p>
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    With MosaicNFT, players can participate in the mining of MosaicNFT mining pool to
                                    earn
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                The Mosaic NFT of MosaicFantasy can be pledged to the Mosaic NFT ore pool for mining.
                                The
                                basic computing power of Genesis NFT is between 10-1000. The better the quality of
                                Mosaic
                                NFT, the higher the basic computing power. The higher the player's NFT mining power, the
                                more profit you get. In addition, the mining revenue obtained by mining power is not
                                static,
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    Players need at least 1 KingKongwill to enter the game and take PVE or PVP
                                    adventures
                                    hereafter. Because players have to use KingKongwill to summon the Mosaic. Here are
                                    the
                                ...
                                <p>
                                    <b>Step4: </b>
                                    Click
                                    the “KingKongwill” sold on the market to find detail information. Please make sure
                                    that
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    In the world of MosaicFantasy, there lives Mosaic and human race together. As a
                                    trainer,
                                    human will tame and train these Mosaics to fight with others as a team. Others may
                                    nourish Mosaics as pets, study Mosaic as a discipline, or just simply take advantage
                                    of
                                    its superpower to complete kinds of tasks. According to fairy tale or legend, human
                                    and
                                    Mosaic share a imitate time in the history.
                                </p>
                                <p>
                                    “How to train your Mosaics?” is an essential
                                    question in this amazing world. People have different ways of training. And there is
                                    no
                                    absolutely perfect training methods. Each way has both pros and cons. However, all
                                    these
                                    training methods are ultimately divided into two categories. One is focusing on the
                                    individual capability of the Mosaic and build strong relationship with it. The other
                                    is
                                ...
                                <p>
                                    ...
                                    friendliness and respect to Mosaics. However, there also exists people who want to
                                    make
                                    use of Mosaics to fulfill their ambitions, such as acquire material reward or even
                                    achieve some goals against the world. Therefore, just like the legendary story
                                    tells,
                                    here comes the battle with Mosaic belonging to different forces. In MosaicFantasy,
                                    human
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    Once entering the world of Mosaic, players need sufficient courage to challenge
                                    unknown
                                    difficulties. More difficult the challenge is, the richer rewards players will
                                    obtain.
                                    For example, if players challenge instance zones, PVE battle will gain you more EXP
                                    (Experience). Players will acquire Tokens by challenging the PVP arena or achieve
                                    more
                                    honors in Trial Tower. Summoning Mosaic gives the players more opportunities to get
                                    the
                                    help of stronger Mosaic. Besides, Guild War allows more warriors gather together to
                                    challenge the Guild to win more awards. There are diverse spectacular activities
                                    waiting
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    $LKK is the BEP-20 Governance Token for the MosaicFantasy world. The $LKK holders
                                    have
                                    the right to vote for the key process in the game governance. Players take part in
                                    the
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    $BLP (Blue Lucky potion) is the game token in the MF (MosaicFantasy) world. Players
                                    can
                                    acquire or consume $BLP by participate PVE adventures or daily targets. Player can
                                    also
                                    ...
                                    equipment or game roles in the game (Not in the NFT market). The distribution of
                                    $BLP is
                                    as follows:
                                </p>
                            </div>
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    $BLP can only be unlocked and used immediately when players hold enough $BLP equal
                                    with
                            ...
                            <div className='learn-more-content-desc'>
                                <p>
                                    In the era of Web 3.0, we believe in decentralized governance. The code is law.
                                    After
                                    the game stepping into stable operation, part of the income of MF (Mosaic Fantasy)
                                    will
                                    ...
                                    part of MF (Mosaic Fantasy) income will be used for $LKK repurchase and burn by
                                    smart
                        ...
                        <div className='learn-more-content'>
                            ...
                            <div className="learn-more-content-desc">
                                <p>
                                    MF (MosaicFantasy) will be online at January 10th,2022. And the LKK public
                                    blockchain
                                    will be completed in the summer of 2022 to establish a totally new metaverse ecology
                                    of
